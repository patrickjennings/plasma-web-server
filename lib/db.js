...
var pool = function() {
    ...
    var pool = new pg.Pool( pg_connection );
...
function save_song_data( file, data ) {
    ...
    return pool.query( sql, [ file, data ] );
}
...
function delete_songs_from_directory( directory, parse_unix_time ) {
    ...
    return pool.query( sql, [ directory, parse_unix_time ] );
}
